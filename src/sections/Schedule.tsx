      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {upcomingSessions.map((session, index) => (
            <article
              key={session.date}
              className="group relative bg-warm-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-all duration-300 border border-cream-dark/30 overflow-hidden"
            >
              {/* Decorative accent */}
              ...
              <div className="relative">
                ...
                <div className="space-y-2 text-warm-gray">
                  ...
                  <p className="flex items-center gap-2">
                    ...
                    <span>{session.location} (תימסר לאחר התיאום)</span>
                  </p>
                </div>
                ...
                <div className="mt-6 pt-5 border-t border-cream-dark/30">
                  <p className="text-sm text-warm-gray-light flex items-center gap-2">
                    ...
                    בקבוצה קטנה, כל משתתף מקבל ליווי אישי
                  </p>
                </div>
              </div>
            </article>
